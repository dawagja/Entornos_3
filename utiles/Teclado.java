...
public class Teclado {
	...
	public static double leerDecimal(String msj) {
	 ...
	 public static boolean deseaContinuar(){//ejecuta un bucle preguntando si deseamos seguir ejecutando el programa, si la respuesta es 'n' o 'N' se sale.
		do{
			switch(Teclado.leerCaracter("\nDesea continuar ejecutando el programa S/N?")){
				...
				case 'N':
					return false;
				default:
					System.out.println("ERROR introduzca una respuesta correcta:S/N");
			}
		}while (true);
	}
